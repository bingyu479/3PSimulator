...
public class UpdateSessionWeb {
    ...
    @PostMapping(value = "/alexa/telehealth/webSession/update",
        consumes= "application/json", produces = "application/json")
    public TelehealthSessionResponse updateWebSessionWithOffer(@RequestBody TelehealthSessionRequest updateSession) {
